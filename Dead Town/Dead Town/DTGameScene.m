...
-(id)init
{
    if (self = [super init])
    {
        ...
        DTControlsLayer *controlsLayer = [DTControlsLayer controlsLayerWithGameLayer:gameLayer controllerType:Joystick controllerDelegate:gameLayer dominantHand:RightHanded];
